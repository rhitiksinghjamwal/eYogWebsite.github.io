						...
						<div class="row">
							...
							?>
								...
								<div class="card ml-5 mt-4" style="width: 18rem;">
									<img class="card-img-top" src="../../<?php echo $course_list['course_image'] ?>" alt="Card image cap">
									<div class="card-body">
										<h5 class="card-title"><?php echo $course_list['course_name']; ?> <a href="edit_topics.php?course_name=<?php echo $course_list['course_name']; ?>" class="h6 text-info float-right">Edit Videos <i class="fa fa-pencil ml-1"></i></a></h5>
										<p class="card-text"><?php echo $course_list['course_description']; ?></p>
									</div>
								</div>
