  ...
  <div class="container-fluid" style="margin-top: 50px;">
    <div class="row">
      ...
      <div class="col-md-10 ">
        ...
        <div>
          <h3 class="text-center mt-2">Manage Your <?php echo $_GET['course_name'];  ?> Online Video Tutorial</h3>
                ...
                <form action="video_add.php" method='POST' enctype="multipart/form-data">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      Enter Video name :<input type="text" name="vid_title" class="form-control">

                    </div>

                    <div class="form-group">
                      Enter Video thumbnail :<input type="file" name="vid_img" class="form-control">
                    </div>
