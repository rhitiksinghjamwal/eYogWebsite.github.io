		...
		<div class="row">
			...
			<div class="col-md-10 ">
				...
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="">Manage Videos</a>
					</li>
				</ul>
				<!-- Nav tabs ends -->
				...
				<div class="tab-content">
					...
					<div class="tab-pane container active" id="home">
						<center>
							<div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b>YOUR VIDEO COURSES</b></div><br>
						</center>
						<div class="row">
							...
							?>
								...
								<div class="card ml-5 mt-4" style="width: 18rem;">
									...
									<div class="card-body">
										<h5 class="card-title"><?php echo $video_list['course_name']; ?> <a href="edit_videos.php?course_name=<?php echo $video_list['course_name']; ?>" class="h6 text-info float-right">View videos <i class="fa fa-pencil ml-1"></i></a></h5>
										<?php echo $video_list['description']; ?></p>
									</div>
								</div>
