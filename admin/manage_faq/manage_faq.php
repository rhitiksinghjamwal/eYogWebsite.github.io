<?php
include("../classes/manage_faq_class.php");
$faq_list = new manage_faq_class;			// creating object of  manage_courses_class.php
$faq = $faq_list->display_faq_list();    //calling display_courses() method from manage_courses_class.php
		...
		<div class="row">
			...
			<div class="col-md-10 ">
				...
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="">Manage FAQ's</a>
					</li>
				</ul>
				<!-- Nav tabs ends -->
				...
				<div class="tab-content">
					...
					<div class="tab-pane container active" id="home">
						<center>
							<div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b>MANAGE FAQ's</b></div><br>
						</center>
						<center>
							<table class="table bg-white" style="height : 355px;overflow-y: scroll;display: inline-block; width:70%">
								<thead>
									<tr>
										<th>Id</th>
					...
					<div class="tab-pane container fade" id="manage_faq">
