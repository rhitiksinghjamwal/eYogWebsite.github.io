...
<body>
	...
	<div>
		<center style="height: 50px; background-color: deepskyblue; ">
			<p class="text-white h3">Watch Free Online Yoga Videos</p>
		</center><br><br>
	</div>
	...
	<section class="banner-1">
		<img class="yoga-img" src="images/yoga2.png" height="450px" width="100%">
	</section>
	...
	<div class="container-fluid" id="yoga-card">
		<center>
			<div class="row">
				...
				$sql = "select * from video_info where course_name = 'Yoga'";
