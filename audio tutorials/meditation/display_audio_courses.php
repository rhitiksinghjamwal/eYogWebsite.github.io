...
<head>
	...
	<!----css file link-->
	<link rel="stylesheet" type="text/css" href="css/video_courses.css">
...
<body>
	...
	<div>
		<center style="height: 50px; background-color: deepskyblue; ">
			<p class="text-white h3">Watch Free Online Meditation Videos</p>
		</center><br><br>
	</div>
	...
	<section class="banner-1">
		<img class="med-img" src="images/meditation6.PNG" height="450px" width="100%">
	</section>
	...
	<div class="container-fluid " id="med-card">
		<center>
			<div class="row">

				<?php

				$sql = "select * from video_info  where course_name = 'Meditation'";
