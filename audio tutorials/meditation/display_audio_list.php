...
<body>
	...
	<div class="container-fluid position-relative" id="med-card1">
				...
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
					<div class="card shadow mycard" style="width: 24rem; height: 12rem;">
						...
						<div class="card-body shadow" style="background-color: #f1f1f1;">
							...
							<a href="meditation_videos.php?video_id=<?php echo $row['video_id'] ?>&course_name=<?php echo $row['course_name'] ?>" class="btn btn-primary border-0 ">Watch Video</a>
						</div>
