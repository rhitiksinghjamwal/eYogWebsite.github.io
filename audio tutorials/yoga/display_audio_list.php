...
<head>
	...
	<!----css file link-->
	<link rel="stylesheet" type="text/css" href="css/audio_list.css">
...
<body>
	...
	<div class="container-fluid position-relative" id="yoga-card1">
		...
		<div class="row">
			...
			$q = "select * from audios where course_name='$course_name'";
			//echo $course_name;
				...
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
					<div class="card shadow mycard" style="width: 24rem; height: 12rem;">
						<div class="inner">
							...
							<img class="card-img-top " style="height: 11rem;" src=../../uploadimg/thumbnail/<?php echo $row['audio_image']; ?> alt="Card image cap">
						</div>

						<div class="card-body shadow" style="background-color: #f1f1f1;">
							<!--  <h5 class="card-title"><?php echo $row['course_name']; ?></h5> -->
							<p class="card-text"><?php echo $row['audio_name']; ?></p>
							<a href="yoga_audios.php?audio_id=<?php echo $row['audio_id'] ?>&course_name=<?php echo $row['course_name'] ?>" class="btn btn-primary border-0 ">Play Audio</a>
						</div>
