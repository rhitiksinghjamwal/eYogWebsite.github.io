...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/meditation_courses.css">
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="#courses-section">Meditation Courses</a></li>
	...
	<section class="banner-1">
		<img class="med-img" src="assets/images/meditation2.png" height="400px" width="100%">
	</section>

	<section class="banner-2">
		<img class="med-img" src="assets/images/meditation3.png" height="100%" width="100%">
	</section>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="section-title text-center">
							<h2><b>MEDITATION COURSES</b></h2>
							<div class="sub-heading">
								<strong>Below are the available meditation audio and video course playlists</strong><br><br>
				...
				<div class="row">
					<div class="col-lg-6 col-sm-6 col-xs-12">
						<div class="courses-wrap text-center">
							...
							<h3><a href="audio_meditation.php">AUDIO COURSE</a></h3>
							<p>
								Here you will have access to audio guided meditation playlist
							</p>
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-xs-12">
						<div class="courses-wrap text-center">
							...
							<h3><a href="video tutorials\meditation\display_video_courses.php">VIDEO COURSE</a></h3>
							<p>
								Here you will have access to video meditation playlist
							</p>
						</div>
					</div>
				</div>
