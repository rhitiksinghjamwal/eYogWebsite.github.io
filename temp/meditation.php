...
<body>
	...
	<section class="banner-1">
		<img class="med-img" src="assets/images/meditation4.png" height="400px" width="100%">
	</section>
					...
					<div class="col-xs-12">
						<div class="section-title text-center">
							...
							<div class="sub-heading">
								<strong>Below are the available meditation audio and video course playlists</strong><br>
				...
				<div class="row">
					<div class="col-lg-6 col-sm-6 col-xs-12">
						<div class="courses-wrap text-center">
							...
							<h3><a href="audio-yoga.php">AUDIO COURSE</a></h3>
							<p>
					...
					<div class="col-lg-6 col-sm-6 col-xs-12">
						<div class="courses-wrap text-center">
							...
							<h3><a href="video-yoga.php">VIDEO COURSE</a></h3>
							<p>
